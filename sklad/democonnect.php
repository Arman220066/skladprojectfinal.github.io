...
$userName = isset($_SESSION['userName']) ? $_SESSION['userName'] : 'Гость (Демо-версия)';
...
$currentView = 'showInnerJoin'; // Вид по умолчанию
...
<div class="container mt-4">
    ...
    <form method="post" class="mb-3">
        ...
        <a href="demo.php" class="btn btn-info me-2">Управление складом</a>
    </form>
